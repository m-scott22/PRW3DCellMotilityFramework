function [htext,hnewax]=ctrlsublabel(varargin)
...
labels=strvcat('a(i)','a(ii)','a(iii)','a(iv)','b(i)','b(ii)','b(iii)','b(iv)','c(i)','c(ii)','c(iii)','c(iv)');
    %'e(i)','e(ii)');
...
for i=1:length(haxes)
  ...
  htext(i)=text(x,y,0,labels(i,:),'fontname', ...  
