function [rootmeansquspeed,S_est,ne,S_lower,S_upper,x,normalized,allvel,v,g,YP,Tj,P_est,logACF,P_lower,P_upper,MSD,YM,lnACF]=sphanalysisinsilico(Alltraj,N,Ncells,T,alphaS,alphaP,mse) 
...
[Tj,YP,P_est,logACF,P_lower,P_upper,lnACF]=velocitycuttinginsilico(Alltraj,Ncells,T,alphaP,mse);
