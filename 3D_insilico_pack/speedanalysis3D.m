...
[rootmeansquspeed,S_est,ne,S_lower,S_upper,~,~,~,~,g,~,~,P_est,~,P_lower,P_upper,MSD,YM]=sphanalysisinsilico(Alltraj,N,Ncells,T,alphaS,alphaP);

%% Plot root mean square speed calculated over all cells at each time point
f1 = figure('PaperSize',[20.98 29.68],'PaperPosition',[1 5 45 18]);
